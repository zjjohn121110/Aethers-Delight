package net.zjjohn121110.aethersdelight.block.entity.renderer;
...
public class HolystoneStoveBlockEntityRenderer implements BlockEntityRenderer<HolystoneStoveBlockEntity> {
    ...
    public HolystoneStoveBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(HolystoneStoveBlockEntity stoveEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn) {
        Direction direction = stoveEntity.getBlockState().getValue(HolystoneStoveBlock.FACING).getOpposite();
