...
public class ADRecipeGenerator extends RecipeProvider implements IConditionBuilder {
    public ADRecipeGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
